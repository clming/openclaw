...
describe("loadVitestExperimentalConfig", () => {
  it("enables the filesystem module cache by default on non-Windows", () => {
  ...
  it("enables the filesystem module cache explicitly on non-Windows", () => {
    expect(
  ...
  it("enables import timing output and import breakdown reporting on non-Windows", () => {
    expect(
      loadVitestExperimentalConfig(
        {
