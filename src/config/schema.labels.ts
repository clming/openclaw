...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.slack.execApprovals": "Slack Exec Approvals",
  "channels.slack.execApprovals.enabled": "Slack Exec Approvals Enabled",
  "channels.slack.execApprovals.approvers": "Slack Exec Approval Approvers",
  "channels.slack.execApprovals.agentFilter": "Slack Exec Approval Agent Filter",
  "channels.slack.execApprovals.sessionFilter": "Slack Exec Approval Session Filter",
  "channels.slack.execApprovals.target": "Slack Exec Approval Target",
