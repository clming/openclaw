...
export const FIELD_HELP: Record<string, string> = {
  ...
  "gateway.handshakeTimeoutMs":
    "WebSocket handshake timeout in milliseconds. Increase on hosts where CLI cold-start ESM compilation blocks the event loop longer than the default 15 seconds. Range: 1000-120000.",
  "gateway.tailscale":
