...
export const FIELD_HELP: Record<string, string> = {
  ...
  "commands.shellProfile":
    "Path to a shell profile file to source before executing commands. When set and non-empty, PowerShell, bash, and other shells will load this profile (e.g., for custom environment variables, aliases, functions). Leave unset for default behavior without profile loading.",
