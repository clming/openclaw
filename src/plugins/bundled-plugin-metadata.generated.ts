...
export const GENERATED_BUNDLED_PLUGIN_METADATA = [
  ...
  {
    dirName: "agent-control",
    idHint: "agent-control",
    source: {
      source: "./index.ts",
      built: "index.js",
    },
    packageName: "@openclaw/agent-control",
    packageVersion: "2026.2.9",
    packageDescription: "Agent Control integration plugin for OpenClaw",
    packageManifest: {
      extensions: ["./index.ts"],
    },
    manifest: {
      ...
      uiHints: {
        ...
        failClosed: {
          label: "Fail Closed",
          help: "Block tool calls when Agent Control is unavailable",
        },
        checkToolCalls: {
          label: "Check Tool Calls",
        },
        checkFinalResponse: {
          label: "Check Final Response",
          help: "Post-run check for observability (advisory, cannot block after generation)",
        },
        syncToolSchemas: {
          label: "Sync Tool Schemas",
          help: "Register discovered OpenClaw tool names in Agent Control",
        },
        llmStepName: {
          label: "LLM Step Name",
          advanced: true,
